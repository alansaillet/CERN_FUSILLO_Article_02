...
\item
  ...
  end surfaces (\hyperref[_Ref225572043]{Figure 4}).
\item
  ...
  exterior envelope (\hyperref[_Ref225571883]{Figure 6}).
\item
  ...
  box\\
  (\hyperref[_Ref225571922]{Figure 5}).
\item
...
pins (\hyperref[_Ref225571883]{Figure 6}). These blocks, featuring
...
(\hyperref[_Ref225571883]{Figure 6}).
...
(\hyperref[_Ref225755796]{Figure 8}).
...
failure) occurred at 67 kN (\hyperref[_Ref225756340]{Figure 10}).
...
11}), while two additional holes allowed air to escape from the
interior.
...
(\hyperref[_Ref225767419]{Figure 13}).
...
(\hyperref[_Ref225761556]{Figure 12}).
...
toolpath definition (\hyperref[_Ref225761556]{Figure 12}). This approach
...
geometry (\hyperref[_Ref225772091]{Figure 14}). The resulting toolpaths
